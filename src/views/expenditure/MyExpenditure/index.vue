        ...
        <el-tab-pane label="" name="list">
          ...
          >
            ...
            <el-table-column fixed="right" label="操作" prop="" min-width="180">
              <template slot-scope="scope">
                <el-link type="text" @click="handleOpenExpDialog(scope.row)">查看</el-link>
              </template>
            </el-table-column>
          </el-table>
          <el-pagination
...
export default {
  ...
  methods: {
    loadMyExpenditure() {
      ...
      appProjectExpenditure(this.actualQuery, this.pageInfo.current, this.pageInfo.size, true).then(res => {
